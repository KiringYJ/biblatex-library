...
This file preserves the project-specific operating guide that previously lived in `CLAUDE.md`. Keep repository architecture, commands, data-safety rules, important paths, domain terms, and project-specific constraints here so all agent entrypoints share the same source of truth.
