...
Generate a project skill at `.claude/skills/sync-agent-workbench/SKILL.md` when the Claude target is enabled. Keep the generated skill body derived from the canonical neutral skill and add only this adapter note.
